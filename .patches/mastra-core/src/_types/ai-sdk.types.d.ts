...
declare interface DataStreamPart<
	CODE extends string,
	NAME extends string,
	TYPE,
> {
 ...
 */
export declare type DeepPartial<T> = T extends z.ZodTypeAny
 ...
 * ```
 */
declare type LanguageModelV1ProviderMetadata = Record<
	string,
...
declare type PartialMap<KeyType, ValueType> = {} & Map<
...
/**
 ...
 @param event - The event that is passed to the callback.
 */
declare type StreamTextOnErrorCallback = (event: {
	error: unknown
}) => Promise<void> | void
...
/**
 A result object for accessing different stream types and additional information.
 */
export declare interface StreamTextResult<
	TOOLS extends ToolSet,
	PARTIAL_OUTPUT,
> {
	/**
...
declare type ToolResultArray<TOOLS extends ToolSet> = Array<
	ToolResultUnion<TOOLS>
>
 ...
 */
export declare type UserContent =
	| string
